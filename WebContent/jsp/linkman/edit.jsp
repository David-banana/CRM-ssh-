						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<tr>
								...
								<td colspan="3"><input type="text" name="custId"
									style="WIDTH: 180px" value="${linkman.cstCustomer.custId}" /></td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkmName" value="${linkman.lkmName}">
								</td>
								<td>联系人性别：</td>
								<td><input type="radio" value="1" name="lkmGender"
							...
							<TR>
								<td>联系人办公电话 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkmPhone" value="${linkman.lkmPhone}">
								</td>
								<td>联系人手机 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkmMobile" value="${linkman.lkmMobile}">
								</td>
							</TR>
							<tr>
